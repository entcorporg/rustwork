...
use crate::mcp::confidence::{ServiceContext, ServiceScope};
use crate::mcp::indexer::{CodeIndex, SourceFile};
use crate::mcp::responses::FunctionReference;
...
pub(crate) fn determine_service_context_from_file(
    ...
    if let Some(service) = &file.service {
        ...
        // Default to monolith if no service context
        ServiceContext::monolith()
    }
}
