...
pub async fn p1_get_route_impact(
    ...
    let method = match params.method.to_uppercase().as_str() {
        "GET" => crate::mcp::routes::HttpMethod::GET,
        "POST" => crate::mcp::routes::HttpMethod::POST,
        "PUT" => crate::mcp::routes::HttpMethod::PUT,
        "PATCH" => crate::mcp::routes::HttpMethod::PATCH,
        "DELETE" => crate::mcp::routes::HttpMethod::DELETE,
        _ => {
            let error = McpError {
